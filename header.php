     ...
     ?>
        ...
        <div id="wrapper">
            ...
            <header>                
                        ...
                        <div class="container">
                            <div class="row">                         
                                ...
                                <div class="col-lg-10 col-md-10 col-sm-10 col-xs-12">
                                    ...
                                    <li ><a  class="apply-now-btn-color hidden-on-mobile" href="register.php">Ücresiz İlan Ver</a></li>
                                    <?php }
                                    ?>        
                                </ul>
                            </div>                          
                ...
                <div style="background-color:##3f51b56e" class="main-menu-area bg-primaryText" id="sticker">
                    <div class="container">
                        <nav id="desktop-nav">
                            <ul>
                                <li class="active"> <a href="index.php"></a></li>
                                <li ><a href="index.php">Anasayfa</a></li>
                                <li ><a href="ilan-detay.php">Tüm ilanlar</a></li>
