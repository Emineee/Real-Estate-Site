            ...
            <div class="col-lg-9 col-md-9 col-sm-8 col-xs-12"> 
                ...
                <div class="settings-details tab-content">
                    <div class="tab-pane fade active in" id="Personal">
                        <h2 class="title-section">İlanlarınız</h2>
                        <div class="personal-info inner-page-padding"> 
                            ...
                            <table class="table table-striped">
                              <thead>
                                <tr>
                                  <th scope="col">#</th>
                                  <th scope="col">İlan Eklenme Tarihi</th>
                          ...
                          <tbody>
                            ...
                            <tr>
                              ...
                              <td><a href="urun-duzenle?urun_id=<?php echo $uruncek['urun_id'] ?>"><button class="btn btn-primary btn-xs">İlan Düzenle</button></a></td>
                              <td>
