                ...
                <div class="row">
                   ...
                   <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">                                           
                    <div class="pLace-order">
                        ...
                        <button style="background-color:grey" class="update-btn disabled" data-toggle="modal" data-target="#sifremiunuttum" type="submit" name="musterigiris" >Şifremi Unuttum</button>
