...
if (isset($_POST['magazaurunekle'])) {
	...
	$duzenle=$db->prepare("INSERT INTO urun SET
		...
		urun_dur=:urun_dur,
		urun_sehir=:urun_sehir,
		urun_nedir=:urun_nedir,
		oda_sayisi=:oda_sayisi,
		daire_kati=:daire_kati,
		bina_kati=:bina_kati,
		bina_yasi=:bina_yasi,
		banyo_sayisi=:banyo_sayisi,
		isinma=:isinma,
		daire_metrekare=:daire_metrekare,
	...
	$update=$duzenle->execute(array(
		'menu_id' => htmlspecialchars($_SESSION['menu_id']),
		...
		'urun_dur' => htmlspecialchars($_POST['urun_dur']),
		'urun_sehir' => htmlspecialchars($_POST['urun_sehir']),
		'urun_adres' => htmlspecialchars($_POST['urun_adres']),
		'urun_nedir' => htmlspecialchars($_POST['urun_nedir']),
		'oda_sayisi' => htmlspecialchars($_POST['oda_sayisi']),
		'daire_kati' => htmlspecialchars($_POST['daire_kati']),
		'bina_kati' => htmlspecialchars($_POST['bina_kati']),
		'bina_yasi' => htmlspecialchars($_POST['bina_yasi']),
		'banyo_sayisi' => htmlspecialchars($_POST['banyo_sayisi']),
		'isinma' => htmlspecialchars($_POST['isinma']),
		'daire_metrekare' => htmlspecialchars($_POST['daire_metrekare']),
