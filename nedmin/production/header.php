      ...
      <div class="col-md-3 left_col">
        <div class="left_col scroll-view">
          <div class="navbar nav_title" style="border: 0;">
            <a href="index.html" class="site_title"><i class="fa fa-paw"></i> <span>YÖNETİCİ PANELİ</span></a>
          </div>
          ...
          <div class="profile clearfix">
            <div class="profile_pic">
              <img src="../../img/B.jpg" alt="..." class="img-circle profile_img">
            </div>
          ...
          <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
            <div class="menu_section">
             ...
             <li><a href="magazalar.php"><i class="fa fa-shopping-basket"></i>Firma</a></li>
             <li><a href="magaza-onay.php"><i class="fa fa-shopping-basket"></i> Firma Başvuruları </a></li>
             <li><a href="kullanici.php"><i class="fa fa-user"></i> Kullanıcılar </a></li>
             <li><a href="urun.php"><i class="fa fa-shopping-basket"></i> İlanlar </a></li>
             <li><a href="kategori.php"><i class="fa fa-list"></i> Kategoriler </a></li>
              <li><a href="menu.php"><i class="fa fa-list"></i> Menu </a></li>
             <li><a href="rapor.php"><i class="fa fa-book"></i> Mesaj Rapor </a></li>
           </ul>
         </div>
       </div>
    </div>
        ...
        <ul class="nav navbar-nav navbar-right">
          <li class="">
            <a href="javascript:;" class="user-profile dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
              <img src="../../img/B.jpg" alt=""><?php echo $kullanicicek['kullanici_ad'] ?> <?php echo $kullanicicek['kullanici_soyad'] ?>
